...
def main(args):
    ...
    # Process reference eye blink video if provided
    ...
    # Process reference pose video if provided
    ...
    # 3D face rendering (optional visualization)
    if args.face3dvis:
        from src.face3d.visualize import gen_composed_video
        gen_composed_video(args, device, first_coeff_path, coeff_path, audio_path, os.path.join(save_dir, '3dface.mp4'))
    
    # Convert coefficients to video
...
if __name__ == '__main__':
    ...
    parser.add_argument("--expression_scale", type=float, default=1.0, help="scale of expressions in the render")
    ...
    parser.add_argument("--still", action="store_true", help="use original videos for full-body animation") 
    parser.add_argument("--preprocess", default='crop', choices=['crop', 'extcrop', 'resize', 'full', 'extfull'], help="how to preprocess the images") 
    parser.add_argument("--verbose", action="store_true", help="save intermediate outputs or not") 
    parser.add_argument("--old_version", action="store_true", help="use the older .pth version") 

    # Additional renderer parameters
    parser.add_argument('--net_recon', type=str, default='resnet50', choices=['resnet18', 'resnet34', 'resnet50'], help='network architecture')
    parser.add_argument('--init_path', type=str, default=None, help='Initialization path')
